    ...
    <AppHeaderLayout
      ...
      rightComponent={
        userDoc?.shopId ? (
          <SearchButton
            onPress={() =>
              navigation.navigate('GlobalSearch', { shopId: userDoc.shopId, userDoc })
            }
          />
        ) : null
      }
      ...
      {vm.hasShop && (
        ...
        >
          ...
          <PendingPurchasesCard
            ...
            onViewAll={() => navigation.getParent()?.navigate('Purchases')}
          />

          <RecentBillsCard
            bills={vm.recentBills}
            loading={vm.loadingRecentBills}
            onViewAll={() => navigation.getParent()?.navigate('Bills')}
          />
