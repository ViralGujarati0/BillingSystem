...
export const en = {
  ...
  home: {
    ...
    payUpi: 'UPI',
    payCard: 'Card',
    legendBillsCount: '{{count}} bills',
    topProducts: 'Top Products',
    topProductsSubtitle: 'by quantity sold',
    qtySold: '{{qty}} sold',
    ...
    viewAll: 'View All',
    noBillsToday: 'No bills today',
    walkIn: 'Walk-in',
    billMetaItems_one: '{{count}} item',
    billMetaItems_other: '{{count}} items',
    pendingPayments: 'Pending Payments',
    totalDue: 'Total Due',
    noPendingPayments: 'No pending payments',
    supplierDefault: 'Supplier',
    comparisonTitle: 'vs Last Period',
    comparisonSwitchHint: 'Switch to 7D or 30D to compare periods',
    metricRevenue: 'Revenue',
    metricProfit: 'Profit',
    metricBills: 'Bills',
    prevPeriod: 'prev {{value}}',
    printReport: 'Print Report',
    myShopDefault: 'My Shop',
  ...
  staffHome: {
    ...
    staffFallback: 'Staff',
    featuresEnabled: '{{enabled}} of {{total}} features enabled',
    quickActions: 'Quick Actions',
    lockedHint: 'Not available — contact owner',
    newBill: 'New Bill',
    newBillDesc: 'Scan or add items to create a bill',
    viewSales: 'View Sales',
    viewSalesDesc: 'Check bills and sales summary',
    viewStock: 'View Stock',
    viewStockDesc: 'Browse and search inventory',
    dashboardSection: 'Home insights',
  },
